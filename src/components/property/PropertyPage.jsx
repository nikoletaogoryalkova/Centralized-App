        ...
        return (
            <div key={1}>
                ...
                <section className="hotel-gallery">
                    <div className="hotel-gallery-bgr" style={(this.state.data.pictures !== undefined && this.state.data.pictures.lenght > 0) ? { 'backgroundImage': 'url(' + this.state.data.pictures[0].original + ')' } : { backgroundColor: '#AAA' }}>
                        <div className="container">
