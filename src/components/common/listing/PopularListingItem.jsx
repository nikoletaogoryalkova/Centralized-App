            ...
            <div className="item active">
                <div className="list-property-small">
                    ...
                    <div className="popular-list-data">
                        <h3><Link to={`/${listingsType}/listings/${this.props.listing.id}?startDate=${moment(new Date(new Date().setHours(24)), 'DD/MM/YYYY').format('DD/MM/YYYY')}&endDate=${ moment(new Date(new Date().setHours(48)), 'DD/MM/YYYY').format('DD/MM/YYYY')}&rooms=%5B%7B"adults":1,"children":%5B%5D%7D%5D`}>{this.props.listing.name}</Link></h3>
