        ...
        return (
            <div className="item active">
                <div className="list-property-small">
                    ...
                    <div className="list-property-price">{this.props.paymentInfo.currencySign}{listingPrice} <span>(LOC {(this.props.listing.defaultDailyPrice / this.props.locRate).toFixed(2)})</span></div>
