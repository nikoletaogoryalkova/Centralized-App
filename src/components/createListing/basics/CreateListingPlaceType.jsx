            ...
            <div>
                ...
                <div className="navigation col-md-12">
                    ...
                    <div className="col-md-7">
                        <NavLink to="/listings/create/landing" className="btn btn-default btn-back" id="btn-continue">
                            <i className="fa fa-long-arrow-left" aria-hidden="true"></i>
                            &nbsp;Back</NavLink>
                        <NavLink to="/listings/create/accommodation" className="btn btn-primary btn-next" id="btn-continue">Next</NavLink>
                    </div>
                </div>
