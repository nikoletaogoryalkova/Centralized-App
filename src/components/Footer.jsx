                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-2">
                            ...
                            <DropdownButton componentClass="div" componentClassName="select-curency" block={true} title={localStorage["currency"] ? localStorage["currency"] : 'USD'} id="bg-nested-dropdown">
