  ...
  getRoomRows(booking) {
    ...
    if (booking) {
      booking.forEach((booking, index) => {
        ...
        if (fees.length === 0) {
          rows.push(
            <tr key={(2 + index) * 1000} className={`booking-room-canx-fee ${this.state.showRoomCanxDetails[index] ? '' : 'room-cancellation-hidden'}`}>
          ...
          rows.push(
            <tr key={(3 + index) * 1000} className={`booking-room-canx-fee ${this.state.showRoomCanxDetails[index] ? '' : 'room-cancellation-hidden'}`}>
          ...
          fees.forEach((fee, feeIndex) => {
            rows.push(
              <tr key={(3 + index) * 1000 + feeIndex + 1} className={`booking-room-canx-fee ${this.state.showRoomCanxDetails[index] ? '' : 'room-cancellation-hidden'}`}>
          ...
          rows.push(
            <tr key={(4 + index) * 1000} className={`booking-room-canx-fee ${this.state.showRoomCanxDetails[index] ? '' : 'room-cancellation-hidden'}`}>
