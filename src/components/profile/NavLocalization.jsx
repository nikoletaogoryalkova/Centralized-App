        ...
        <div className="source-data">
          <div className="info">
            {this.props.location.pathname !== '/hotels'
              ...
              ? <ul className="tabset">
                <li className={this.props.location.pathname.indexOf('/hotels') !== -1 ? 'active' : ''}><NavLink to='/hotels' activeClassName="active">HOTELS</NavLink></li>
                <li className={this.props.location.pathname.indexOf('/homes') !== -1 ? 'active' : ''}><NavLink to='/homes' activeClassName="active">HOMES</NavLink></li>
              </ul>
              : <div>&nbsp;</div>
            }
